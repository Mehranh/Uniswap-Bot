...
contract mySwapContract {
  ...
  function getBalance() external view returns(uint256 x){
    ...
    function subTest(address router_address,address token,uint256 reserveWETHTarget) external view   returns (   uint256 x  ) {
